  ...
  return (
    <>
      <header className='flx-column-centred'>
        <img className="lightPadding" src='/src/assets/classic_logo.png' alt="Digimon Logo with rookie Digimon characters"></img>
      ...
      <footer className='flx-row-centred lightPadding'>
        ...
        <div className="credit">Images belong to Toei | Bandai.<br></br><a href="https://www.deviantart.com/megacrystalswiftail/art/Classic-Digimon-Logo-With-Salamon-1091774940">Main logo rework by MegaCrystalSwiftail</a> on DeviantArt.</div>
      </footer>
    </>
  )
}
