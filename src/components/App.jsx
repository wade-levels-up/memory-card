  ...
  return (
    <>
      ...
      <footer className='flx-row-centred lightPadding'>
        ...
        <div className="credit">Images belong to Toei | Bandai. <a href="https://www.deviantart.com/megacrystalswiftail/art/Classic-Digimon-Logo-With-Salamon-1091774940">Main logo rework by MegaCrystalSwiftail</a> on DeviantArt.</div>
      </footer>
    </>
  )
}
